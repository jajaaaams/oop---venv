...
class Command(BaseCommand):
    ...
    def create_collection(self):
        collection1 = Collection(card=PokemonCard.objects.get(name="Pikachu"), trainer=Trainer.objects.get(name="Gary"), collection_date="2023-12-12")
        collection2 = Collection(card=PokemonCard.objects.get(name="Charmeleon"), trainer=Trainer.objects.get(name="Ash"), collection_date="2023-12-12")
        collection3 = Collection(card=PokemonCard.objects.get(name="Mewtwo"), trainer=Trainer.objects.get(name="Gold"), collection_date="2023-12-12")
        collection4 = Collection(card=PokemonCard.objects.get(name="Caterpie"), trainer=Trainer.objects.get(name="Aaron"), collection_date="2023-12-12")
        collection5 = Collection(card=PokemonCard.objects.get(name="Squirtle"), trainer=Trainer.objects.get(name="Roxanne"), collection_date="2023-12-12")
        collection6 = Collection(card=PokemonCard.objects.get(name="Eevee"), trainer=Trainer.objects.get(name="Cedric"), collection_date="2023-12-12")
        collection7 = Collection(card=PokemonCard.objects.get(name="Snorlax"), trainer=Trainer.objects.get(name="Cedric"), collection_date="2023-12-12")
        collection8 = Collection(card=PokemonCard.objects.get(name="Raikou"), trainer=Trainer.objects.get(name="Silver"), collection_date="2023-12-12")
        collection9 = Collection(card=PokemonCard.objects.get(name="Cryogonal"), trainer=Trainer.objects.get(name="Gold"), collection_date="2023-12-12")
        collection10 = Collection(card=PokemonCard.objects.get(name="Pancham"), trainer=Trainer.objects.get(name="Ronald"), collection_date="2023-12-12")
        collection11 = Collection(card=PokemonCard.objects.get(name="Entei"), trainer=Trainer.objects.get(name="Steven"), collection_date="2023-12-12")
        ...
        collection20 = Collection(card=PokemonCard.objects.get(name="Deoxys"), trainer=Trainer.objects.get(name="Ash"), collection_date="2023-12-12")
